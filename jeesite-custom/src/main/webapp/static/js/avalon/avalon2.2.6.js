...
*/(function (global, factory) {
    ...
    avalon.config = { debug: false }; //by huangyun 默认关闭debug模式
    function log() {
    ...
    (function () {
        ...
        if (typeof console === 'object') {
            ...
            // Function.apply.call(method, con, welcomeIntro); //注释掉控制台信息。by huangyun
            // con.log(welcomeMessage); //注释掉控制台信息。by huangyun
            if (method !== console.log) {
                // con.groupEnd(welcomeIntro); //注释掉控制台信息。by huangyun
            }
        }
    })();
