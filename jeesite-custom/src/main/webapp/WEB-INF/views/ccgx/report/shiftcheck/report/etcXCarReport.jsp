        ...
        $(function () {
            ...
            $("#btn-excel").click(function(){
                ...
                ccgx_table2excel.exportExcel({
                    ...
                    fileName: 'ETC出口车辆报表' + $("#selectDateStr").val() + '.班次' + $("#shiftturn").val(),
                    title: 'ETC出口车辆报表' + $("#selectDateStr").val() + '.班次' + $("#shiftturn").val(),
...
<body>
    <div class="formWrap">
        <form action="${ctx}/shiftcheck/report/etcXCar" id="searchForm" role="form" class="form-inline">
        	<div class="form-top clearfix">
	            <h1 class="form-title">ETC出口车辆报表</h1>
            ...
            <table id="table-report" width="100%" border="1" class="table table-bordered hover stripe compact">
                <thead>
                    ...
                    <th align="center" valign="middle">应收金额</th>
                    <th align="center" valign="middle">车辆数</th>
                </thead>
                <c:if test="${not empty etcXCarReport}">
                <tfoot>
                    <tr>
                ...
                <tbody>
                    <c:forEach items="${etcXCarReport}" var="car" varStatus="status">
                        <tr>
                            ...
                            <td align="center" valign="middle">${car['RECEIVABLE_CASH'] * 0.01}</td>
