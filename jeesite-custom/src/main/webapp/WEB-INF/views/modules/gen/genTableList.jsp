		...
		<c:forEach items="${page.list}" var="genTable">
			<tr>
				...
				<shiro:hasPermission name="gen:genTable:edit"><td>
    				<a class="btn-operate" href="${ctx}/gen/genTable/form?id=${genTable.id}">修改</a>
					<a class="btn-operate" href="${ctx}/gen/genTable/delete?id=${genTable.id}" onclick="return confirmx('确认要删除该业务表吗？', this.href)">删除</a>
