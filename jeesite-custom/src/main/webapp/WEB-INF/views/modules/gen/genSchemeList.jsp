		...
		<c:forEach items="${page.list}" var="genScheme">
			<tr>
				...
				<shiro:hasPermission name="gen:genScheme:edit"><td>
    				<a class="btn-operate" href="${ctx}/gen/genScheme/form?id=${genScheme.id}">修改</a>
					<a class="btn-operate" href="${ctx}/gen/genScheme/delete?id=${genScheme.id}" onclick="return confirmx('确认要删除该生成方案吗？', this.href)">删除</a>
