		...
		<c:forEach items="${page.list}" var="genTemplate">
			<tr>
				...
				<shiro:hasPermission name="gen:genTemplate:edit"><td>
    				<a class="btn-operate" href="${ctx}/gen/genTemplate/form?id=${genTemplate.id}">修改</a>
					<a class="btn-operate" href="${ctx}/gen/genTemplate/delete?id=${genTemplate.id}" onclick="return confirmx('确认要删除该代码模板吗？', this.href)">删除</a>
