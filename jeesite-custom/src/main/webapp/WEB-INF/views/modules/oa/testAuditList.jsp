		...
		<c:forEach items="${page.list}" var="testAudit">
			<tr>
				...
				<shiro:hasPermission name="oa:testAudit:edit"><td>
    				<a class="btn btn-info" href="${ctx}/oa/testAudit/form?id=${testAudit.id}">详情</a>
					<a class="btn btn-danger" href="${ctx}/oa/testAudit/delete?id=${testAudit.id}" onclick="return confirmx('确认要删除该审批吗？', this.href)">删除</a>
