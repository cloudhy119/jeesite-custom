...
<div class="wrapper">
	...
	<form:form id="inputForm" modelAttribute="guestbook" action="${ctx}/cms/guestbook/save" method="post" class="form-horizontal">
		...
		<div class="form-actions"><c:if test="${guestbook.delFlag eq '2'}">
			...
			<input id="btnSubmit" class="btnSave" type="submit" value="通 过" onclick="$('#delFlag').val('0')"/>&nbsp;
			<input id="btnSubmit" class="btnReject" type="submit" value="驳 回" onclick="$('#delFlag').val('1')"/>&nbsp;</shiro:hasPermission></c:if>
