		...
		<c:forEach items="${page.list}" var="site">
			<tr>
				...
				<shiro:hasPermission name="cms:site:edit"><td>
    				<a class="btn-operate" href="${ctx}/cms/site/form?id=${site.id}">修改</a>
					<a class="btn-operate" href="${ctx}/cms/site/delete?id=${site.id}${site.delFlag ne 0?'&isRe=true':''}" onclick="return confirmx('确认要${site.delFlag ne 0?'恢复':''}删除该站点吗？', this.href)" >${site.delFlag ne 0?'恢复':''}删除</a>
