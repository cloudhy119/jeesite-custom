...
<div class="wrapper">
	...
	<form:form id="inputForm" modelAttribute="article" action="${ctx}/cms/article/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="articleData.codeCountry" class="input-xlarge ">
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<sys:ckfinder input="filePath" type="files" uploadPath="/cms/article" selectMultiple="false"/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="form-actions">
			...
			<input id="btnSubmit" class="btnSave" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
			<input id="btnCancel" class="btnBack" type="button" value="返 回" onclick="history.go(-1)"/>
		</div>
	</form:form>
	</div>
</body>
