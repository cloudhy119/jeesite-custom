		...
		<c:forEach items="${page.list}" var="testData">
			<tr>
				...
				<shiro:hasPermission name="test:testData:edit"><td>
    				<a class="btn-operate" href="${ctx}/test/testData/form?id=${testData.id}">修改</a>
					<a class="btn-operate" href="${ctx}/test/testData/delete?id=${testData.id}" onclick="return confirmx('确认要删除该单表吗？', this.href)">删除</a>
