		...
		<c:forEach items="${page.list}" var="testDataMain">
			<tr>
				...
				<shiro:hasPermission name="test:testDataMain:edit"><td>
    				<a class="btn-operate" href="${ctx}/test/testDataMain/form?id=${testDataMain.id}">修改</a>
					<a class="btn-operate" href="${ctx}/test/testDataMain/delete?id=${testDataMain.id}" onclick="return confirmx('确认要删除该主子表吗？', this.href)">删除</a>
