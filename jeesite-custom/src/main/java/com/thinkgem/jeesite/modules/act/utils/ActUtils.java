...
//	private static Logger logger = LoggerFactory.getLogger(ActUtils.class);
	...
	public static final String[] PD_TBT_AUDIT = new String[]{"tbt_audit", "std_tbt"};
	public static final String[] PD_STANTARD_AUDIT = new String[]{"standard_audit", "temp_std_standard"};
	public static final String[] PD_ZJ_AUDIT = new String[]{"zj_audit", "std_zj_data"};
	public static final String[] PD_JL_AUDIT = new String[]{"jl_biaozhun", "std_jl_measure"};
	public static final String[] PD_JLBZ_AUDIT = new String[]{"jlbz", "std_jl_standard"};
	public static final String[] PD_TJ_AUDIT = new String[]{"tj_flow", "std_tj_standard"};
	public static final String[] PD_GOODSCODE_AUDIT = new String[]{"goodscode_audit", "std_goods_code"};
	public static final String[] PD_ENTRUST_AUDIT = new String[]{"entrust_audit", "std_standard_entrust"};
	public static final String[] PD_TECHREG_AUDIT = new String[]{"tech_reg", "std_tech_reg"};
